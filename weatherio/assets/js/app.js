  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      <h2 class="title-2" id="highlights-label">Todays Highlights</h2>
                        <div class="highlight-list">
                            <div class="card card-sw highlight-card one">
        ...
        module.aqiText[aqi].message
                            ...
                            <div class="card card-sw highlight-card two">
                            ...
                            <div class="card card-sw highlight-card">
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
                  <div class="card card-sw slider-card">
                      <p class="body-3">${module.getHours(
                        dataTimeUnix,
                        timezone
                      )}</p>
                      <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48"
                          loading="lazy" alt="${description}" title="${description}" class="weather-icon" />
        ...
        <div class="card card-sw slider-card">
            ...
            <img src="./assets/images/weather_icons/direction.png" width="48" height="48"
                loading="lazy" alt="" class="weather-icon" style="transform: rotate(${
                  windDirection - 100
                }deg)" />
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        <p class="label-1">${date.getDate()} ${
          module.monthsNames[date.getMonth()]
        }</p>
