...
TOKEN: Final = '6732164277:AAHJm0d0U0gDkQ-k1rUqAArIOy2mlHbW5Fk'
BOT_USERNAME: Final = '@weather_wise247_bot'

# Commands
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
  await update.message.reply_text('Hello! Welcome to WeatherWise.')
...
async def content_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
  await update.message.reply_text('We will provide you the weather update')
